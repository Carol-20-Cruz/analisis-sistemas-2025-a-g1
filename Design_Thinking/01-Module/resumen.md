...
-En IBM, definimos el diseño como la intencionalidad que subyace detrás del resultado: ¿por qué queremos que algo funcione de una manera determinada? Requiere no solo comprender el resultado. Para diseñar bien, también tenemos que entender al usuario, desarrollar empatía por el usuario y conocer qué pretende conseguir el usuario mediante el uso de nuestro diseño.
...
Priorice las necesidades de las personas que utilizarán su solución. El éxito no se mide por las características y las funciones; se mide por lo bien que satisfacemos las necesidades de los usuarios.

Reinvención sin descanso
¡Todo es un prototipo! Todo, incluso los productos y las soluciones ya existentes. Si pensamos en todo como una simple repetición de algo anterior, podemos aportar nuevas ideas incluso a los problemas más antiguos.
...
Design Thinking incluye tres principios: centrarse en los resultados del usuario, empoderar a equipos diversos y reinventar sin descanso.

Design Thinking utiliza el circuito para comprender continuadamente las necesidades de los usuarios y ofrecer resultados. Los equipos usan el circuito para tratar deresolver un problema indeterminado mientras observan, reflexionan y crean.

Todo es un prototipo en Design Thinking, un producto no terminado que siempre se puede ir repitiendo y reinventando.

Las claves se utilizan para hacer que Design Thinking funcione a escala. Los hitos nos ponen al mismo nivel como equipos, las reproducciones nos ponen al mismo nivel a lo largo del tiempo y los usuarios patrocinadores nos ponen a mismo nivel que la realidad de nuestros usuarios.

Design Thinking capacita a los equipos para probar ideas más audaces. Esta libertad conduce de forma inherente a unos resultados más innovadores y a mejores ideas.
